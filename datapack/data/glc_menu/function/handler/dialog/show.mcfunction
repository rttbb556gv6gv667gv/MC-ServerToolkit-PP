...
# Dialog göster
execute as @p[tag=gulce_admin,tag=!closed.glc,limit=1,sort=arbitrary,distance=..1] at @s positioned ~ ~ ~ rotated as @s run function glc_menu:handler/dialog/show_final with storage mc:dialog
